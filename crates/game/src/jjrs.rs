...
use crate::{character::{config::CharacterConfig, enemy::create::spawn_enemy, player::{create::create_player, jjrs::PeerConfig}}, collider::{spawn_test_wall, CollisionLayerSettings}, global_asset::GlobalAsset, plugins::AppState, weapons::{WeaponAsset, WeaponsConfig}};
...
pub fn setup_ggrs_local(
    ...
    for (i, addr) in session_config.players.iter().enumerate() {
        ...
        create_player(&mut commands, &global_assets, &weapons_asset,  &character_asset, &asset_server, &mut texture_atlas_layouts, &sprint_sheet_assets, local, i);
    }
...
pub fn wait_for_players(
    ...
    sprint_sheet_assets: Res<Assets<SpriteSheetConfig>>,
    session_config: Res<GggrsSessionConfiguration>,
    layer_settings: Res<CollisionLayerSettings>,
    ...
    for (i, player) in players.into_iter().enumerate() {
        ...
        create_player(&mut commands, &global_assets, &weapons_asset,  &character_asset, &asset_server, &mut texture_atlas_layouts, &sprint_sheet_assets, is_local, i);
    }
