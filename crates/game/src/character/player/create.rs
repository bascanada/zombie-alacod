...
use animation::{AnimationBundle, AnimationMapConfig, ShadowSkin, Skin, SpriteSheetConfig};
...
pub fn create_player(
    ...
    let animation_bundle =
        AnimationBundle::new(map_layers, animation_handle.clone(), bmap!("body" => String::new(), "hair" => String::new()));
